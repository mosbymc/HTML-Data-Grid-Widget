...
import { callGridEventHandlers } from './grid_util';
import { toolbarGenerator } from './toolbar_generator';
...
var headerGenerator = {
        ...
        gridConfig.columns.forEach(function _createColumnHeaders(col, idx) {
            ...
            if (col.type !== 'custom') {
                ...
                if (gridConfig.sortable === true && (typeof col.sortable === general_util.jsTypes.undefined || col.sortable === true)) {
                    headerGenerator.setSortableClickListener(th);
                    gridConfig.sortable = true;
                }

                if (col.filterable === true) {
                    headerGenerator.setFilterableClickListener(th, gridConfig, col.field);
                ...
                if ((col.editable || gridConfig.selectable || gridConfig.groupable || gridConfig.columnToggle || gridConfig.excelExport || gridConfig.advancedFiltering))
                    toolbarGenerator.createToolbar(gridConfig, gridElem, col.editable);
            ...
            if (gridConfig.resizable) {
                th.on('mouseleave', headerGenerator.mouseLeaveHandlerCallback);
            }
            if (gridConfig.reorderable === true && (typeof col.reorderable === general_util.jsTypes.undefined || col.reorderable === true)) {
                ...
                headerGenerator.setDragAndDropListeners(th);
            }
        });
        headerTable.css('width','');
        headerGenerator.setColWidth(gridConfig, gridElem);
     ...
     */
    setSortableClickListener: function _setSortableClickListener(elem) {
     ...
     */
    setFilterableClickListener: function _setFilterableClickListener(elem, gridConfig, col) {
     ...
     */
    setDragAndDropListeners: function _setDragAndDropListeners(elem) {
        ...
        elem.on('drop', function handleDropCallback(e) {
            ...
            if (gridConfig.resizable) {
                droppedClone.on('mouseleave', headerGenerator.mouseLeaveHandlerCallback);
                targetClone.on('mouseleave', headerGenerator.mouseLeaveHandlerCallback);
            }
            ...
            headerGenerator.swapContentCells(parentDivId, droppedIndex, targetIndex);
     ...
     */
    setColWidth: function _setColWidth(gridData, gridElem) {
    ...
    mouseLeaveHandlerCallback: function _mouseLeaveHandlerCallback(e) {
     ...
     */
    swapContentCells: function _swapContentCells(gridId, droppedIndex, targetIndex) {
