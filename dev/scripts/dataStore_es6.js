...
var booleanExpression = {
    ...
    appendNewExpression: function _appendNewExpression(expression, field, value, operator, dataType, conjunct) {
        ...
        if (expression.filterGroup.length < 2) {
            ...
            this.filterGroup = Array.prototype
                .concat(expression.filterGroup.slice(0, expression.filterGroup.length - 1))
                .concat([{ conjunct: conjunct, filterGroup: [findLastFilter(expression), filter]}]);
        }
        return this;
    },
    conjunct: null,
...
var generateId = (function uid(seed) {
...
var expressionParser = (function _expressionParser() {
    ...
    return { createFilterTreeFromFilterObject: createFilterTreeFromFilterObject };
})();
